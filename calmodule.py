...
def embedresult_lister(response:json):
    ...
    embedresult_lister.set_footer(text="스타워즈")
...
def embedskill(response:json):
    ...
    embedskill.set_footer(text="스타워즈")
...
def embedresult_jewlist(response:json):
    ...
    embedresult_jewlist.set_footer(text="스타워즈")
...
def embedresult_goldget(response:json):
    ...
    embedresult_goldget.set_footer(text="스타워즈")
...
def embedresult_sasalist(response:json, 닉네임:str):
    ...
    embedresult_sasalist.set_footer(text="스타워즈")
...
def embedresult_auction(가격:int):
    ...
    embedresult_auction.set_footer(text="스타워즈")
...
def embedresult_crystal(response:json):
    ...
    embedresult_crystal.set_footer(text="스타워즈")
...
def embedresult_island(response:json):
    ...
    embedresult_island.set_footer(text="스타워즈")
...
def embedresult_gearlist(response:json):
   ...
   for (const i in ItemList) {
    ...
    embedresult_gear2list.set_footer(text="스타워즈")
